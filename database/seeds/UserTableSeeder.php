...
class UserTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        User::create(['name' => 'RONALD DUQUE', 'email' => null, 'username' => 'RDUQUE', 'email_verified_at' => now(), 'password' => bcrypt('RDUQUE'), 'active_user' => 'enabled', 'role' => 'operator', 'process_id' => 1]);
        User::create(['name' => 'RAUL ESCOBAR', 'email' => null, 'username' => 'RESCOBAR', 'email_verified_at' => now(), 'password' => bcrypt('RESCOBAR'), 'active_user' => 'enabled', 'role' => 'operator', 'process_id' => 4]);
        ...
        User::create(['name' => 'SAMUEL PAIZ', 'email' => null, 'username' => 'SPAIZ', 'email_verified_at' => now(), 'password' => bcrypt('SPAIZ'), 'active_user' => 'enabled', 'role' => 'operator', 'process_id' => 4]);
        User::create(['name' => 'DENYS MEJIA', 'email' => null, 'username' => 'DMEJIA', 'email_verified_at' => now(), 'password' => bcrypt('DMEJIA'), 'active_user' => 'enabled', 'role' => 'operator', 'process_id' => 4]);
        ...
        User::create(['name' => 'CRISTIAN PEREZ', 'email' => null, 'username' => 'CPEREZ', 'email_verified_at' => now(), 'password' => bcrypt('CPEREZ'), 'active_user' => 'enabled', 'role' => 'operator', 'process_id' => 1]);
        User::create(['name' => 'JONATHAN SOSA', 'email' => null, 'username' => 'JSOSA', 'email_verified_at' => now(), 'password' => bcrypt('JSOSA'), 'active_user' => 'enabled', 'role' => 'operator', 'process_id' => 1]);
        ...
        User::create(['name' => 'MIGUEL REVELO', 'email' => null, 'username' => 'LREVELO', 'email_verified_at' => now(), 'password' => bcrypt('LREVELO'), 'active_user' => 'enabled', 'role' => 'operator', 'process_id' => 1]);
        ...
        User::create(['name' => 'HERBERT ALVARENGA', 'email' => null, 'username' => 'HALVARENGA', 'email_verified_at' => now(), 'password' => bcrypt('HALVARENGA'), 'active_user' => 'enabled', 'role' => 'operator', 'process_id' => 1]);
