...
class UserTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        User::create(['name' => 'EDGARDO RAFAEL SANCHEZ MEJIA', 'email' => 'esanchez@enerwire.com', 'username' => 'ESANCHEZ', 'email_verified_at' => now(), 'password' => bcrypt('secret'), 'active_user' => 'enabled', 'role' => 'operator', 'process_id' => 4]);
        ...
        User::create(['name' => 'MOISES ELIAS HERNANDEZ LOPEZ', 'email' => 'mhernandez@enerwire.com', 'username' => 'MHERNANDEZ', 'email_verified_at' => now(), 'password' => bcrypt('secret'), 'active_user' => 'enabled', 'role' => 'operator', 'process_id' => 2]);
