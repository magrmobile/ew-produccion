    ...
    <div class="card-body">
        ...
        <form action="{{ url('machines') }}" method="post">
            ...
            <div class="form-group">
                ...
                <div class="custom-control custom-radio mb-3">
                    <input name="location" class="custom-control-input" id="location1" type="radio"
                        @if(old('location', 'Santo Tomas') == 'Santo Tomas') checked @endif value="Santo Tomas">
                    <label for="location1" class="custom-control-label">Santo Tomas</label>
                </div>
                <div class="custom-control custom-radio mb-3">
                    <input name="location" class="custom-control-input" id="location2" type="radio"
                        @if(old('location') == 'Santa Elena') checked @endif value="Santa Elena">
                    <label for="location2" class="custom-control-label">Santa Elena</label>
                </div>
            </div>
