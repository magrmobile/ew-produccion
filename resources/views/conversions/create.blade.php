...
<div class="card shadow">
    <div class="card-header border-0">
        ...
        <div class="col">
            <h3 class="mb-0">Nueva Conversion</h3>
        </div>
