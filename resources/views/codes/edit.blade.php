    ...
    <div class="card-body">
        ...
        <form action="{{ url('codes/'.$code->id) }}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="number" name="code" class="form-control" value="{{ old('code', $code->code) }}" required>
            </div>
            <div class="form-group">
                <label for="description">Descripcion</label>
                <input type="text" name="description" class="form-control" value="{{ old('description', $code->description) }}" required>
            </div>
            <div class="form-group">
                <label for="type">Tipo de Paro</label>
                <div class="custom-control custom-radio mb-3">
                    <input name="type" class="custom-control-input" id="type1" type="radio"
                        @if($code->type == 'Programado') checked @endif value="Programado">
                ...
                <div class="custom-control custom-radio mb-3">
                    <input name="type" class="custom-control-input" id="type2" type="radio"
                        @if($code->type == 'No Programado') checked @endif value="No Programado">
