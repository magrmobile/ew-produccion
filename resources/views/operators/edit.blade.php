...
<div class="card shadow">
    ...
    <div class="card-body">
        ...
        <form action="{{ url('operators/'.$operator->id) }}" method="post">
            ...
            <div id="div_active" class="form-group">
                <label for="active">Activo</label>
                <select name="active" id="active" class="form-control form-control-sm" data-live-search="true">
                    <option value="">Seleccionar Estado</option>
                    <option value="1" @if($operator->active == 1) selected @endif>Si</option>
                    <option value="0" @if($operator->active == 0) selected @endif>No</option>
                </select>
            </div>
