...
<body>
    <table style="width: 100%;"> 
        ...
        <tr align="center"><td class="titulo2">NOTA DE REMISION</td></tr>
                                ...
                                <tr>
                                    <td align="center">
                                        ...
                                        <table class="receptor">
                                            ...
                                            <tr>
                                                <td align="right">No. de Doc. de Identificacion:</td>
                    ...
                    <tr>
                        <td>
                            <table class="bordered" style="width: 100%;">
                                ...
                                <tr>
                                    <td colspan="4"></td>
                                    <td colspan="4" style="text-align: right; padding: 3px;" class="celda">Suma Total de Operaciones:</td>
