...
<div class="card shadow">
    <div class="card-header border-0">
        ...
        <div class="col">
            <h3 class="mb-0">Editar Dispositivo</h3>
        </div>
    ...
    <div class="card-body">
        ...
        <form action="{{ url('devices/'.$device->id) }}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" id="mac_address" name="mac_address" class="form-control" value="{{ old('mac_address', $device->mac_address ) }}" required>
            </div>
            <div class="form-group">
